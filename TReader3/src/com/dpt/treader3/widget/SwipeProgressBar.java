...
final class SwipeProgressBar {
	...
	/**
	 * 根据手势的位移变化 Update the progress the user has made toward triggering the
	 * swipe gesture. and use this value to update the percentage of the trigger
	 * that is shown.
	 */
	void setTriggerPercentage(float triggerPercentage) {
		mTriggerPercentage = triggerPercentage;
		mStartTime = 0;
		// mParent == SwipeRefreshLayout
